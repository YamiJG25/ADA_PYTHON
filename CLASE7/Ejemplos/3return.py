...
# Ejemplo 2 de retorno de multiples valores
def obtener_datos():
    nombre = "Ana"
    edad = 30
    return nombre, edad #retorne valores como una tupla
# Asignamos los valores a la variable
nombre, edad = obtener_datos()
print("Ejemplo 2 de retorno de multiples valores: ")
