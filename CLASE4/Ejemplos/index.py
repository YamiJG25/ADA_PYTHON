...
print("El nuemro 30 se encuentra en la posicion: ", indice_de_30, "de la tupla")
...
if valor_buscado in mi_tupla:
    ...
    print(f"El numero {valor_buscado} se encuenta en la posicion {indice_del_valor} de la tupla.")
else:
    #si el valor no esta en la tupla, mostrar el mensaje
