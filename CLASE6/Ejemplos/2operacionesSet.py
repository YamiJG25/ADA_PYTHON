...
# Superconjunto
es_superconjuto = conjunto_b.issuperset(conjunto_a)
print(f"Es conjunto_b un superconjunto de conjunto_a: {es_superconjuto}")

# Disconjunto
son_disconjuntos = conjunto_a.isdisjoint(conjunto_c)
print(f"Son conjunto_a y conjunto_c disconjuntos?: {son_disconjuntos}")
...
print(f"Conjunto_a despues de la diferencia con conjunto_b: {conjunto_a}")

# Symmetric Difference update
conjunto_a.symmetric_difference_update(conjunto_b)
print(f"Conjutno_a despues de la diferencia simetrica con conjunto_b: {conjunto_b}")